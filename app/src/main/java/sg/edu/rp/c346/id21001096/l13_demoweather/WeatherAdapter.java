package sg.edu.rp.c346.id21001096.l13_demoweather;
...
class WeatherAdapter extends ArrayAdapter<Weather> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentWeather.getForecast().contains("Fair")){
            Picasso.with(parent_context).load("https://www.nea.gov.sg/assets/images/icons/weather-bg/FA.png").into(iv);
        } else if (currentWeather.getForecast().contains("Cloudy")){
            Picasso.with(parent_context).load("https://www.nea.gov.sg/assets/images/icons/weather-bg/CL.png").into(iv);
        }
